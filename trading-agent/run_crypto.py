"""
Crypto Strategy Runner - FIXED
Runs 24/7 crypto trading (markets never close!)
"""
import sys
import os
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))

# Import crypto config FIRST
...
# Import crypto data fetcher and patch it BEFORE other imports
from utils import data_fetcher_crypto
sys.modules['utils.data_fetcher'] = data_fetcher_crypto
...
class CryptoTradingRunner:
    """Runs 24/7 crypto trading strategy"""
    ...
    def __init__(self):
        ...
        print("\n" + "="*70)
        print("🪙 CRYPTO TRADING SYSTEM (24/7)")
        print("="*70)
        print("⚠️  This is PAPER TRADING ONLY - No real money at risk")
        print("💡 Crypto markets never close - trading 24/7/365!")
        print("="*70 + "\n")
